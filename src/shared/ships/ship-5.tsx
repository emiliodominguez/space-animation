	...
	>
		...
		<defs>
			...
			<linearGradient
				...
				x2="112.14"
				y2="101.48"
				xlinkHref="#s5-linear-gradient-5"
			/>
			<linearGradient
			...
			<linearGradient
				...
				x2="66.39"
				y2="85.67"
				xlinkHref="#s5-linear-gradient-11"
			/>
			<linearGradient
			...
			<linearGradient
				...
				x2="-.24"
				y2="48.62"
				xlinkHref="#s5-linear-gradient-24"
			/>
			<linearGradient
			...
			<linearGradient
				...
				x2="171.76"
				y2="60.16"
				xlinkHref="#s5-linear-gradient-10"
			/>
			<linearGradient
			...
			<radialGradient
				id="s5-radial-gradient-4"
				cx="-4.14"
				cy="44.72"
				r="11.45"
				gradientTransform="rotate(45.36 -17.367 80.62)"
				xlinkHref="#s5-radial-gradient-3"
			/>
		</defs>
			...
			<g id="Capa_2" data-name="Capa 2">
				<g id="Layer_3" data-name="Layer 3">
					...
					<ellipse
						...
						rx="29.64"
						ry="8.48"
						style={{ fill: "url(#s5-linear-gradient-5)" }}
						className="s5-cls-8"
					/>
					<g className="s5-cls-8">
						<ellipse
							cx="80.33"
							cy="101.48"
							rx="31.81"
					...
					<path
						...
						style={{
							fill: "url(#s5-linear-gradient-10)",
							mixBlendMode: "multiply",
						}}
					/>
					<path
						...
						style={{
							fill: "url(#s5-linear-gradient-11)",
							opacity: 0.28,
							mixBlendMode: "screen",
						}}
					/>
					...
					<path
						...
						style={{
							fill: "url(#s5-linear-gradient-13)",
							mixBlendMode: "multiply",
						}}
					/>
					<path
						...
						style={{
							fill: "url(#s5-linear-gradient-14)",
							mixBlendMode: "multiply",
						}}
					/>
					<ellipse
					...
					<ellipse
						...
						style={{
							fill: "url(#s5-linear-gradient-17)",
							mixBlendMode: "screen",
						}}
					/>
					<path
					...
					<path
						...
						style={{
							opacity: 0.7,
							fill: "url(#s5-linear-gradient-18)",
							mixBlendMode: "multiply",
						}}
					/>
					<use
					...
					<path
						...
						style={{
							fill: "url(#s5-linear-gradient-21)",
							opacity: 0.28,
							mixBlendMode: "multiply",
						}}
					/>
					...
					<path
						...
						style={{
							fill: "url(#s5-linear-gradient-23)",
							opacity: 0.67,
						}}
					/>
					<path
						...
						style={{
							fill: "url(#s5-linear-gradient-24)",
							mixBlendMode: "screen",
						}}
					/>
					<path
					...
					<use
						style={{
							fill: "url(#s5-linear-gradient-26)",
							mixBlendMode: "multiply",
						}}
						xlinkHref="#s5-reuse-2"
					/>
					<path
						...
						style={{
							fill: "url(#s5-linear-gradient-27)",
							opacity: 0.69,
							mixBlendMode: "screen",
						}}
					/>
					<path
						...
						style={{
							fill: "url(#s5-linear-gradient-28)",
							opacity: 0.28,
							mixBlendMode: "multiply",
						}}
					/>
					<path
						...
						style={{ fill: "url(#s5-linear-gradient-29)" }}
					/>
					<path
					...
					<path
						...
						style={{
							fill: "url(#s5-linear-gradient-34)",
							opacity: 0.69,
							mixBlendMode: "screen",
						}}
					/>
